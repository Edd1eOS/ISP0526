...
export const ADAPTIVE_QUESTION_SYSTEM_PROMPT = [
    ...
    "",
    "2. Career outcome or post-study intent — always ask once even if city is known.",
    ...
    "",
    "3. city_size — if not in knownFacts.",
    "   '你倾向哪种规模的城市？'",
    "   quickPicks: '超大城市（首都/一线）', '大城市', '中型大学城', '无偏好'",
    "",
    "4. Academic background signal — only if level=master/phd.",
    "   Ask about GPA range or exam score type (高考/GPA/A-level/etc.).",
    "",
    "5. Hard constraint — visa sponsorship, proximity to family, scholarship required.",
